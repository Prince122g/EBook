...
<body style="background-color: #f5f7fa">
	...
	<div class="container-fluid"
		style="margin-left: px; margin-right: 40px;">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img style="height: 557px; width: 100%" class="d-block w-100"
						src="img/Pri.jpg" alt="First slide">
				</div>
				<div class="carousel-item">
					<img style="height: 557px; width: 100%" class="d-block w-100"
						src="img/Pri2.jpg" alt="Secong slide">
				</div>
				<div class="carousel-item">
					<img style="height: 557px; width: 100%" class="d-block w-100"
						src="img/Pri3.png" alt="Third slide">
				</div>
			</div>
							...
							<div class="card-body text-center">
								...
								<div class="row text-center">
									...
									<a href="#" class="btn btn-success btn-sm ml-5">View
										Details</a> <i class="btn btn-danger btn-sm ml-1"
										class="fa-solid fa-indian-rupee-sign">${row.price}</i> <a
										href="login.jsp" class="btn btn-primary btn-sm ml-1">Add
										to Cart</a>
